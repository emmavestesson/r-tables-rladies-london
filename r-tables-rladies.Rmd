...
.pull-right[
gtsummary 
<img src="https://github.com/ddsjoberg/gtsummary/raw/main/man/figures/logo.png" style="width: 80%" />
]
...
```{r}
library(survival)
 m1 <- coxph(Surv(ttdeath, death) ~ age , trial) %>%
...
```{r}
 m2 <- coxph(Surv(ttdeath, death) ~ age + marker, trial) %>%
  tbl_regression(exponentiate = TRUE)
